...
AUDIO_FOLDER = os.path.join(parent_dir, "data_final", "final_dataset_3s_5s_STp2")
OUTPUT_CSV = "dataset_metadata_full_STp2.csv"

# Thông tin cứng
MOVIE_NAME = "Sinh tử"
Link = "https://www.youtube.com/watch?v=ifR2XlGkE7g"
