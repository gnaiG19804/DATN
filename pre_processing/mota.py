...
AUDIO_FOLDER = os.path.join(parent_dir, "data_final", "final_dataset_3s_5s_HSCS")
OUTPUT_CSV = "dataset_metadata_full_HSCS.csv"

# Thông tin cứng
MOVIE_NAME = "Hồ sơ cá sấu"
Link = "https://www.youtube.com/watch?v=9JV8eB39yZ8"
