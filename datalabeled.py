...
CSV_PATH = "DataLabel/metadata - dataset_metadata_HSCS.csv"       # Tên file CSV bạn vừa sửa xong
SOURCE_FOLDER = "data_final/final_dataset_3s_5s_HSCS"   # Thư mục chứa tất cả các file âm thanh lộn xộn
OUTPUT_DIR = "SORTED_BY_EMOTION_HSCS"          # Thư mục đích (Code sẽ tự tạo)
