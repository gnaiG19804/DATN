...
AUDIO_FOLDER = os.path.join(parent_dir, "data_final", "final_dataset_3s_5s_TNNV")
OUTPUT_CSV = "dataset_metadata_full_TNNV.csv"

# Thông tin cứng
MOVIE_NAME = "Thương ngày nắng về"
Link = "https://www.youtube.com/watch?v=8a1g4eS4G7g"
