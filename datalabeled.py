...
CSV_PATH = "DataLabel/metadata - dataset_metadata_QBBp3.csv"       # Tên file CSV bạn vừa sửa xong
SOURCE_FOLDER = "data_final/final_dataset_3s_5s_QBBp3"   # Thư mục chứa tất cả các file âm thanh lộn xộn
OUTPUT_DIR = "SORTED_BY_EMOTION_QBBp3"          # Thư mục đích (Code sẽ tự tạo)
