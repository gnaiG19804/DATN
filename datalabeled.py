...
CSV_PATH = "DataLabel/TD.csv"       # Tên file CSV bạn vừa sửa xong
SOURCE_FOLDER = "n8n-custom/data/TD/final_3to5s"   # Thư mục chứa tất cả các file âm thanh lộn xộn
OUTPUT_DIR = "SORTED_BY_TD"          # Thư mục đích (Code sẽ tự tạo)
